...
> 用法详解见 [开发指南](https://github.com/joesdu/velashell-plugin-templates/blob/main/docs/dev-guide.md)，测试策略见 [13-testing-strategy.md](https://github.com/joesdu/VelaShell/blob/main/docs/plugins/13-testing-strategy.md)。
